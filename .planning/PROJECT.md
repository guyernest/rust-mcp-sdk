...
---
*Last updated: 2026-06-14 — Phase 95 complete (pmcp-workbook-server Shape A pure-config binary mirroring pmcp-sql-server; test trio + --bundle-id proptest + reader-free purity gate + slot-9a wiring; requirement WBCL-06 validated); previously 2026-06-12 — Phase 93 complete (pmcp-workbook-compiler full offline pipeline + §5 generalization fixes + change-class/golden-corpus promote gate)*
