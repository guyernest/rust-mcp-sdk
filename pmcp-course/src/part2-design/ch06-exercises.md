...
{{#quiz ../quizzes/ch06-beyond-tools.toml}}

## Exercises

1. **[Prompt Design Workshop](./ch06-ex01-prompt-design.md)** ⭐⭐ Intermediate (25 min)
...
- [Part III: Cloud Deployment](../part3-deployment/ch07-deployment-overview.md) - Deploy to production
- Review [Part II Exercises](./ch04-exercises.md) - Practice more design patterns
