...
//! Plan 05, moved to the 0.2 line by Phase 120 (D-08/D-09).
//!
//! cargo-pmcp MUST pin `pmcp-package` at the caret `"0.2"` string (NOT `=0.2.0`,
//! NOT `0.2.0`) so a portable `.pmcp` package produced by any published
//! `pmcp-package = 0.2.x` stays inspectable by this CLI. This test parses
