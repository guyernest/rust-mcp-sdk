...
<required_reading>
@/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
