...
- **Global scope**: `/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/notes/`)
...
2. Glob `/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/notes/` — works in any directory
