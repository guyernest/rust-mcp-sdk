...
```bash
PHASE_INFO=$(node "/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/Users/guy/Development/mcp/sdk/rust-mcp-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
