...
function useWidgetReady() {
  ...
  const [isReady, setIsReady] = (0, import_react.useState)(runtime.isReady);
...
function useWidgetHost() {
  const runtime = getRuntime();
  const [host, setHost] = (0, import_react.useState)(runtime.host);
  (0, import_react.useEffect)(() => {
...
function useWidgetState(initialState) {
  ...
  const [state, setLocalState] = (0, import_react.useState)(getInitialState);
  (0, import_react.useEffect)(() => {
...
function useToolInput() {
  const runtime = getRuntime();
  const [input, setInput] = (0, import_react.useState)(() => runtime.getToolInput());
  (0, import_react.useEffect)(() => {
...
function useToolOutput() {
  const runtime = getRuntime();
  const [output, setOutput] = (0, import_react.useState)(() => runtime.getToolOutput());
  (0, import_react.useEffect)(() => {
...
function useTheme() {
  const runtime = getRuntime();
  const [theme, setTheme] = (0, import_react.useState)(() => runtime.theme);
  (0, import_react.useEffect)(() => {
...
function useLocale() {
  const runtime = getRuntime();
  const [locale, setLocale] = (0, import_react.useState)(() => runtime.locale);
  (0, import_react.useEffect)(() => {
...
function useDisplayMode() {
  const runtime = getRuntime();
  const [mode, setMode] = (0, import_react.useState)(() => runtime.currentDisplayMode);
  (0, import_react.useEffect)(() => {
...
function useMaxHeight() {
  const runtime = getRuntime();
  const [height, setHeight] = (0, import_react.useState)(() => runtime.maxHeight);
  (0, import_react.useEffect)(() => {
...
function useSafeArea() {
  const runtime = getRuntime();
  const [safeArea, setSafeArea] = (0, import_react.useState)(() => runtime.safeArea);
  (0, import_react.useEffect)(() => {
...
function useWidgetView() {
  const runtime = getRuntime();
  const [view, setView] = (0, import_react.useState)(() => runtime.view);
  (0, import_react.useEffect)(() => {
